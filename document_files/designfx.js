...
function fixThumbnailImageLayout(image)
{
    ...
    if (image.height() / image.width() < 0.66) {
...
function enableTransparentHeader() {      return;

    var topSection = $('.mz_grid > .section');
